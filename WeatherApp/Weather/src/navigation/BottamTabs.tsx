...
export type BottamTabsParamList = {
  Home: undefined;
  MyCityScreen: undefined;
  MapScreen: undefined;
  SettingsScreen: undefined;
};

const Tab = createBottomTabNavigator<BottamTabsParamList>();
...
const BottamTabs = () => {
  return (
    <Tab.Navigator
      screenOptions={{
        headerShown: false,
        tabBarStyle: { backgroundColor: colors.bottamTabsColor },
      }}
    >
      <Tab.Screen
        name="Home"
